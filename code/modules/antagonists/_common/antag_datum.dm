...
/datum/antagonist/proc/render_preview_outfit(datum/outfit/outfit, mob/living/carbon/human/dummy)
	...
	var/icon = get_flat_uni_icon(dummy)
...
/datum/antagonist/proc/finish_preview_icon(datum/universal_icon/preview_icon)
	// Zoom in on the top of the head and the chest
	// I have no idea how to do this dynamically.
	preview_icon.scale(115, 115)

	// This is probably better as a Crop, but I cannot figure it out.
	preview_icon.shift(WEST, 8, 115, 115)
	preview_icon.shift(SOUTH, 30, 115, 115)

	preview_icon.crop(1, 1, ANTAGONIST_PREVIEW_ICON_SIZE, ANTAGONIST_PREVIEW_ICON_SIZE)
