...
/datum/antagonist/fugitive/get_preview_icon()
	...
	var/datum/universal_icon/fug_1 = make_background_fugitive_icon(/datum/outfit/yalp_cultist)
	fug_1.shift(WEST, 8, 32, 32)
	final_icon.blend_icon(fug_1, ICON_UNDERLAY)
	//to the right add waldo (we just had to, okay?)
	var/datum/universal_icon/fug_2 = make_background_fugitive_icon(/datum/outfit/waldo)
	fug_2.shift(EAST, 8, 32, 32)
	final_icon.blend_icon(fug_2, ICON_UNDERLAY)
