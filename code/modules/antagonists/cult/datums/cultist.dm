...
/datum/antagonist/cult/get_preview_icon()
	...
	var/obj/item/melee/cultblade/longsword = /obj/item/melee/cultblade
	icon.blend_icon(uni_icon(initial(longsword.lefthand_file), initial(longsword.inhand_icon_state)), ICON_OVERLAY)
