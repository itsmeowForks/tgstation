...
/datum/antagonist/rev/head/get_preview_icon()
	...
	var/datum/universal_icon/assistant_left = make_assistant_icon("Business Hair")
	assistant_left.shift(WEST, 8, 32, 32)
	var/datum/universal_icon/assistant_right = make_assistant_icon("CIA")
	assistant_right.shift(EAST, 8, 32, 32)
	final_icon.blend_icon(assistant_left, ICON_UNDERLAY)
	final_icon.blend_icon(assistant_right, ICON_UNDERLAY)
