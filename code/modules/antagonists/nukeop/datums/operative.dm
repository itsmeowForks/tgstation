...
/datum/antagonist/nukeop/get_preview_icon()
	...
	if (!isnull(preview_outfit_behind))
		...
		var/datum/universal_icon/teammate_left = teammate.copy()
		teammate_left.shift(WEST, ICON_SIZE_X / 4, 32, 32)
		var/datum/universal_icon/teammate_right = teammate.copy()
		teammate_right.shift(EAST, ICON_SIZE_X / 4, 32, 32)

		final_icon.blend_icon(teammate_left, ICON_UNDERLAY)
		final_icon.blend_icon(teammate_right, ICON_UNDERLAY)
